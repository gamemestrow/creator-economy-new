          ...
          <div className="mx-auto max-w-7xl px-6 py-8">
            ...
            <div className="mb-8 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-6">
                ...
                <p className="mt-1 text-xs text-gray-500">Start exploring courses</p>
              </div>
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-6">
                ...
                <p className="mt-2 text-2xl font-bold text-gray-900">0</p>
                <p className="mt-1 text-xs text-gray-500">Complete your courses</p>
              </div>
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-6">
                ...
                <p className="mt-2 text-2xl font-bold text-gray-900">0</p>
                <p className="mt-1 text-xs text-gray-500">Achieve your milestones</p>
              </div>
              ...
              <div className="rounded-xl border border-gray-200 bg-white p-6">
                ...
                <p className="mt-2 text-2xl font-bold text-gray-900">0</p>
                <p className="mt-1 text-xs text-gray-500">Connect with others</p>
              </div>
            </div>
            ...
            <div className="mb-8">
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {/* Empty State */}
                <div className="col-span-full rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 px-6 py-12 text-center">
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-6">
              ...
              <div className="rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 px-6 py-12 text-center">
                ...
                <p className="text-sm text-gray-600">
                  Join the community to be notified of upcoming events and webinars.
                </p>
              </div>
            </div>
          </div>
