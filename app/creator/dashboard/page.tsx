  ...
  return (
    <div className="min-h-screen bg-[#F8F8F5]">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              <button
                ...
                className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-primary from-amber-500 to-orange-600 text-white rounded-lg text-xs sm:text-sm font-bold shadow-[0_10px_30px_rgba(0,0,0,0.05)] hover:shadow-[0_10px_30px_rgba(0,0,0,0.05)] transition-all hover:scale-105 active:scale-95"
              >
      ...
      <div className="flex min-h-[calc(100vh-73px)]">
        ...
        {sidebarOpen && (
          <div 
            className="fixed inset-0 bg-foreground/20 backdrop-blur-sm z-10 md:hidden top-[73px]" 
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="mb-8 grid gap-4 sm:gap-6 grid-cols-1 xs:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div key={stat.label} className="rounded-xl border border-border bg-white p-5 sm:p-6 hover:shadow-[0_10px_30px_rgba(0,0,0,0.05)] transition-shadow">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground truncate">{stat.sub}</p>
                </div>
              ))}
            </div>
      ...
      {showCreateForm && (
        ...
        >
          <div className="w-full max-w-xl max-h-[90vh] overflow-y-auto shadow-[0_10px_30px_rgba(0,0,0,0.05)]">
            <CreateCourseForm
              onSubmit={async (data) => {
                if (!user) return
                await createCourse({
