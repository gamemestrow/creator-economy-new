...
import { Plus, MoreHorizontal, Brain, Zap, MessageSquare, TrendingUp } from 'lucide-react'
    ...
    <div className="flex-1 overflow-auto">
      <div className="p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Manage AI-powered assistants and automation</p>
        </div>
