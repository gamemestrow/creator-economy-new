        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="flex items-start gap-4 flex-1">
            ...
            <div className="space-y-4 flex-1">
              <div>
                <h2 className="text-2xl font-extrabold text-foreground">Basic - Zero Fixed Fee</h2>
              </div>
              
              {/* Transaction Charges */}
              <div className="bg-muted border border-border rounded-xl p-4 max-w-sm">
          ...
          <div className="bg-[#FFFBF7] border border-[#ffeedc] rounded-xl p-5 lg:w-96 text-center lg:text-left space-y-4">
            <p className="text-sm font-semibold text-muted-foreground leading-normal">
              For more upgrade to <strong className="text-foreground">Pro</strong> or <strong className="text-foreground">Premium Plan</strong> now
            </p>
            <button 
