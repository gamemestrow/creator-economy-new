...
export default function CommunitiesPage() {
    ...
    const {loading: authLoading, user,authorized,} = useRequireRole(["creator"]);
    ...
    const totalPosts = communities.reduce(
        (sum, community) => sum + (community.postsCount || 0),
        0,
    );
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground mt-1">
                                    These will be visible to all members.
                                </p>
                            </div>
