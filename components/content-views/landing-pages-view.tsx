    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">Create and manage high-converting landing pages</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <p className="text-3xl font-bold text-gray-900 mt-2">16,240</p>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <p className="text-3xl font-bold text-gray-900 mt-2">11.1%</p>
          <p className="text-sm text-blue-600 mt-3">Excellent performance</p>
        </div>
      </div>

      {/* Chart */}
      <div className="bg-white border border-gray-200 rounded-lg p-6">
        <h2 className="text-lg font-bold text-gray-900 mb-6">Weekly Performance</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {pages.map((page) => (
          <div key={page.id} className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-lg transition">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className={`text-xs px-2 py-1 rounded mt-1 inline-block ${
                    page.live ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'
                  }`}>
            ...
            <div className="grid grid-cols-3 gap-2 mb-4 text-center">
              <div>
                ...
                <p className="text-lg font-bold text-gray-900">{page.visits.toLocaleString()}</p>
              </div>
              <div>
                <p className="text-sm text-gray-600">Conversions</p>
                <p className="text-lg font-bold text-gray-900">{page.conversions.toLocaleString()}</p>
              </div>
              <div>
            ...
            <div className="flex gap-2">
              <button className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-blue-50 text-blue-600 rounded hover:bg-blue-100 transition text-sm font-medium">
                <Eye className="w-4 h-4" />
                Preview
              </button>
              <button className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-gray-50 text-gray-700 rounded hover:bg-gray-100 transition text-sm font-medium">
